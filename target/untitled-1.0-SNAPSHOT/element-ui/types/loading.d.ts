...
/** Options used in Loading com.service */
...
export interface ElLoading {
  ...
  /** If you do not have a specific DOM node to attach the Loading directive, or if you simply prefer not to use Loading as a directive, you can call this com.service with some configs to open a Loading instance. */
